                    ...
                    <form onSubmit={handleDiscountSubmit}>
                      <div className="od-form-body">
                        <div className="od-form-grid">
                          ...
                          <div className="od-form-group"><label className="od-form-label">Discount % *</label><input className="od-form-input" type="number" min="1" max="99" required placeholder="20" value={discountForm.discountPercent} onChange={(e) => setDiscountForm((p) => ({ ...p, discountPercent: e.target.value }))} /></div>
